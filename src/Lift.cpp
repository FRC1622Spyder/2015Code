...
public:
	...
	virtual void Periodic(Spyder::RunModes runmode)
	{
		...
		case Spyder::M_AUTO:
		{
			 ...
			 */
			/*
			 * DEAR COMMUNIST OVERLORD,
			 * YOUR COMMENTS DO NOT TRIFFLE ME. I AM ONE WITH THE NAVAJO TACO AND
			 * TOGETHER WE ARE STRONG. YOUR INLAWS (IF YOU ACTUALLY OBTAIN ANY) WOULD BE
			 * BLINDED BY THE INSANE AWESOMENESS OF THE GLORIOUS CODE I SUNG INTO EXISTANCE.
			 * YOUR CODE, AS A MATURE CEO WOULD PUT IT, UNEXCEPTABLE. MR PRESIDENT IS NOT A WORTHY
			 * NAME OF YOUR BEING.
			 *
			 * -K
			 *
